    ...
    .container.tarjeta.tarjeta--blanca.p-4.p-md-5
      ...
      .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
        ...
        .col-12.col-md-8.col-lg-9
          .titulo-segundo
            h2 Prueba de conocimientos sobre exploración, validación y visualización de datos para la toma de decisiones
          p.mb-4 Validar el conocimiento adquirido sobre exploración, validación y visualización de datos para la toma de decisiones. Esto se trabaja a partir de un conjunto de preguntas con el propósito de buscar una dinámica de razonamiento ágil sobre opciones cerradas y reafirmar un conocimiento declarado dentro del componente.
